  ...
  return (
    ...
    <div className='fondo'>
      <Routes>
        ...
        <Route path="/res_tusne_insti" element={<Layout><Res_tusne_Int /></Layout>} />
        <Route path="/add_tusne_insti" element={<Layout><Add_tusne_Int /></Layout>} />
        ...
        <Route path="/listaLab" element={<Layout><ListaLaboratorios /></Layout>} />
        <Route path="/complete_lab" element={<Layout><Complete_la /></Layout>} />
        <Route path="/complete_lab_admin" element={<Layout><Complete_la_Admin /></Layout>} />
        ...
        <Route path="/info_lab_admin" element={<Layout><InfoLabAdmin /></Layout>} />
        ...
        <Route path="/vermislaboratorios" element={<Layout><Vermislaboratorios /></Layout>} />
        <Route path="/vermisinstitutos" element={<Layout><VermisInstitutos /></Layout>} />
        ...
        <Route path="/update_poi" element={<Layout><Update_Poi /></Layout>} />
        ...
        <Route path="/update_resp_insti" element={<Layout><UpdateRes_insti /></Layout>} />
        ...
        <Route path="/info_poi" element={<Layout><View_info_poi /></Layout>} />
        ...
        <Route path="/update_maintenance" element={<Layout><Update_Maintenance /></Layout>} />
        <Route path="/res_maintenance" element={<Layout><Res_maintenance /></Layout>} />
        <Route path="/res_insti_admin" element={<Layout><ResInstiAdmin /></Layout>} /> {/* */}
        <Route path="/res_insti_dire" element={<Layout><ResInstiDire /></Layout>} />
        <Route path="/res_insti_adminLista" element={<Layout><ResInstiAdminLista /></Layout>} />
